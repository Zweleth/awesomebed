...
let {createToken} = require('../middleware/AuthenticateUser');
...
class User{
                ...
                await compare(userPass, 
                    ...
                    (cErr, cResult)=> {
                        ...
                        if(cResult) {
                            ...
                            res.status(401).json({
                                err: 'You entered an incorrect password.'
                            })
                        }
                    })
            }
    ...
    fetchUser(req, res) {
        ...
        `
        SELECT userID, firstName, lastName, gender, emailAdd, userRole, userProfile FROM Users WHERE userID = ?;
        `
